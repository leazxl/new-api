...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/claude-code/oauth/start", controller.StartClaudeCodeOAuth)
			channelRoute.POST("/claude-code/oauth/complete", controller.CompleteClaudeCodeOAuth)
			channelRoute.POST("/:id/claude-code/oauth/start", controller.StartClaudeCodeOAuthForChannel)
			channelRoute.POST("/:id/claude-code/oauth/complete", controller.CompleteClaudeCodeOAuthForChannel)
			channelRoute.POST("/:id/claude-code/refresh", controller.RefreshClaudeCodeChannelCredential)
		...
		logRoute.GET("/self/stat/tokens", middleware.UserAuth(), controller.GetLogsSelfStatTokens)
