...
type AccentTone = 'brand' | 'warning' | 'info' | 'pupple'
...
> = {
  brand: {
    activeText: 'text-[#06D290] dark:text-[#06D290]',
    activeBorder: 'border-[#06D290] dark:border-[#06D290]',
    badge:
      'bg-[#06D290]/10 text-[#06D290] dark:bg-[#06D290]/10 dark:text-[#06D290]',
  },
  warning: {
    activeText: 'text-[#FF6A0C] dark:text-[#FF6A0C]',
    activeBorder: 'border-[#FF6A0C] dark:border-[#FF6A0C]',
    badge:
      'bg-[#FF6A0C]/10 text-[#FF6A0C] dark:bg-[#FF6A0C]/10 dark:text-[#FF6A0C]',
  },
  info: {
    activeText: 'text-[#2D57E7] dark:text-[#2D57E7]',
    activeBorder: 'border-[#2D57E7] dark:border-[#2D57E7]',
    badge:
      'bg-[#2D57E7]/10 text-[#2D57E7] dark:bg-[#2D57E7]/10 dark:text-[#2D57E7]',
  },
  pupple: {
    activeText: 'text-[#7A3BFF] dark:text-[#7A3BFF]',
    activeBorder: 'border-[#7A3BFF] dark:border-[#7A3BFF]',
    badge:
      'bg-[#7A3BFF]/10 text-[#7A3BFF] dark:bg-[#7A3BFF]/10 dark:text-[#7A3BFF]',
  },
}
      ...
      >
        ...
        >
          ...
          <div className='ml-auto flex items-center gap-2 pr-2 sm:pr-3'>
            <span className='inline-block size-1.5 rounded-full bg-[#06D290] shadow-[0_0_8px_rgba(6,210,144,0.45)]' />
...
function Command(props: { children: ReactNode }) {
  return (
    <span className='font-medium text-[#06D290] dark:text-[#06D290]'>
      {props.children}
    </span>
  )
}
...
function Flag(props: { children: ReactNode }) {
  return (
    <span className='text-[#2D57E7] dark:text-[#2D57E7]'>{props.children}</span>
  )
}

function Key(props: { children: ReactNode }) {
  return (
    <span className='text-[#2D57E7]/80 dark:text-[#2D57E7]'>{props.children}</span>
  )
}

function StringText(props: { children: ReactNode }) {
  return (
    <span className='text-[#FF6A0C] dark:text-[#FF6A0C]'>{props.children}</span>
  )
}

function NumberText(props: { children: ReactNode }) {
  return (
    <span className='font-medium text-[#7A3BFF] dark:text-[#7A3BFF]'>
      {props.children}
    </span>
  )
}
